...
public class CsvExporter implements ILayerExporter {
    ...
    private final StringBuffer currentRow = new StringBuffer(2048);
    ...
    public CsvExporter() {
        this(new FileOutputStreamProvider(DEFAULT_EXPORT_FILE_NAME, new String[] { CSV_FILE_FILTER }, new String[] { CSV_FILE_EXTENSION }));
    }
